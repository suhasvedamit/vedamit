...
// #region agent log
debugLog('deploy-gh-pages diagnostics', {
  insideGit,
...
// #region agent log
debugLog('spawning gh-pages', { argCount: ghArgs.length, repoArgSource }, 'H-A');
// #endregion
...
// #region agent log
debugLog('gh-pages exit', { status: run.status ?? 'null' }, 'H-A', 'post-spawn');
// #endregion
